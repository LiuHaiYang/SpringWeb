        ...
        <div class="wrap clearfix">
            <div class="login-box-wind">
                ...
                <div class="login-cnt">
                    ...
                    <form id="loginForm" action="login.do" name="loginForm" method="post" novalidate="novalidate">
                        <ul>
                            <li>
                    ...
                    <div class="frm-lst-smt">
                        <a href="javascript:tologin();" class="btn-red-big" id="loginIn"><span>登录</span></a>
                    </div>
                    <div class="fgt">
                    	<a href="register.jsp" class="now-reg-btn"><span>立即注册</span></a>
