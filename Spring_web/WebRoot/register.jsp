    	...
    	<div class="wrap clearfix">
            <div class="reg-box-l">
                ...
                <center><font style="color:red">${requestScope.errorInfo }</font></center>
                	<form id="regform" action="reg.do" name="regform" method="post"
							novalidate="novalidate" enctype="multipart/form-data" >
                    <ul>
                    <li>
                <div class="nor-frms-tit"> 手机号</div>
                <div class="nor-frms-inp">
                 <input type="text" value="" placeholder="可用于登录和找回密码" class="nor-inp focus" id="username" name="username">
                </div>
                ...
                <li>
                    ...
                    <div class="nor-frms-inp">
                        <input type="password" value="" placeholder="密码" class="nor-inp focus" id="password" name="password">
                        <!-- <div class="nor-frms-tips">
                            长度为6~14个字符，支持数字，大小写字母及标点符号
                        </div> -->
                    </div>
                    <div class="nor-frms-yz" id="password_tips"></div>
                        ...
                        <li>
                            ...
                            <div class="nor-frms-inp">
                                <input type="password" value="" placeholder="确认密码" class="nor-inp focus" id="password" name="password">
                                <!-- <div class="nor-frms-tips">
                                    长度为6~14个字符，支持数字，大小写字母及标点符号
                                </div> -->
                            </div>
                        ...
                        <li class="xyz-frm-tag">
                            <div class="nor-frms-tit">
                                &nbsp;
                            </div>
                            <div class="nor-frms-inp">
                                <span class="my-checkbox" id="mycheckbox" name="mycheckbox">
                                    <label id="agree"><em>阅读并接受</em></label><a href="javascript:void(0);" target="_blank">《全国大学生创业服务网用户协议》</a>
                                </span>
                            </div>
                    ...
                    <div class="reg-submit">
                        <a href="javascript:toreg();" class="btn-blue-big" id="register"><span>注册</span></a>
                    </div>
                </div>
            </div>
            <!--reg-box-l End-->
