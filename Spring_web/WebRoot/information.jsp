...
<title>${requestScope.infor.infoTitle }</title>
</head>
<body>
	<!--头部-->
				...
				<div class="cont-left">
					<div class="article-box">
						<div class="article-box-tit">
							<h4>${requestScope.infor.infoTitle }</h4>
			<span>发布时间：<em> 
			<fmt:formatDate value="${requestScope.infor.infoTime}" pattern="yyyy年MM月dd日HH:mm:ss"/>			</em></span>
						</div>
						<div class="article-box-head">
						<c:if test="${not empty requestScope.infor.infoImg }">
							<p style="text-align: center">
								<img alt="" zcmsimagerela="292396"
									style="width: 137px; height: 171px"
									src="images/${requestScope.infor.infoImg }" border="0">
							</p>
						</c:if>
							<c:import url="/context/${requestScope.infor.infoContext }"/>
						</div>
					</div>
