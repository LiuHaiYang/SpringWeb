						...
						<div class="txtScroll-left">
							<div class="bd">
								<div class="tempWrap"
									...
									<ul class="infoList"
										style="width: 2394px; left: 0px; position: relative; overflow: hidden; padding: 0px; margin: 0px;">
...
<c:forEach items="${requestScope.itemList }" var="item" begin="0" end="5">
	<li class="fl">
		<p class="phot">
			<img
		...
		<p class="name">${item.itemTitle }
			...
			<c:if test="${item.itemInvest eq 0 }">
			<i class="invest_ico_gray"></i>
			</c:if>
		</p>
		<p class="tits">${item.itemUnit }</p>
		<p class="link">
			<a>${item.industry.industryTitle}</a>
		</p>
		<p class="weal">
		<c:forEach items="${item.typeList }" var="itemType">
			<a javascript:void(0);="" class="one">${itemType.typeName }</a>
			</c:forEach>
		</p>
	</li>
	</c:forEach>
			...
			<div class="body_right fr">
				<div class="br_main_cnt fr">
					<div class="cst_box">
						...
						<div class="cst_bd">
							<div class="news_box">
								...
								<c:forEach items="${requestScope.inforList }"     var="infor" begin="0" end="9">
									<li>
											<a href="inforbyid.do?id=${infor.infoId }"><i class="square"></i> ${infor.infoTitle }</a>
									</li>
									</c:forEach>
								</ul>
					...
					<div class="cst_box">
						<div class="cst_tp">
							<div class="sct_tp_bdr clearfix">
								<h4 class="fl">创业政策<i class="arrow_ico"></i>
								</h4>
								<div class="cst_tp_r fr">
									<a
										href=""
						...
						<div class="cst_bd">
							<div class="news_box">
								<ul class="news_all_list">
								<c:forEach items="${requestScope.newsList }" var="news"  begin="0" end="9">
									<li>
										<a href="javascript:void(0)"><iclass="square"></i>${news.newsTitle }</a>
									</li>
								</c:forEach>
								</ul>
